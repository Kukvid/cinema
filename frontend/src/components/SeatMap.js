      ...
      <Box
        sx={{
          ...
          '&:hover': {
            ...
            boxShadow: isBooked ? 'none' : '0 4px 8px rgba(0,0,0,0.3)',
          },
        }}
  ...
  return (
    <Box>
      ...
      <Box sx={{ mb: 4, textAlign: 'center' }}>
        ...
        >
          <Typography variant="h6" sx={{ color: '#e50914', fontWeight: 600 }}>
            ЭКРАН
          </Typography>
        </Paper>
      </Box>
          ...
          >
            ...
            <Box sx={{ display: 'flex', gap: 0.5 }}>
              {rows[rowNumber]
                ...
                .map((seat) => (
                  <Box key={seat.id} title={`Ряд ${seat.row_number}, Место ${seat.seat_number}`}>
                    {getSeatIcon(seat)}
                  </Box>
                ))}
            </Box>
      ...
      >
        <Chip
          icon={<SeatIcon sx={{ color: '#46d369 !important' }} />}
          label="Свободно"
          sx={{
        ...
        />
        <Chip
          icon={<SeatIcon sx={{ color: '#f44336 !important' }} />}
          label="Занято"
          sx={{
        ...
        />
        <Chip
          icon={<SeatIcon sx={{ color: '#2196f3 !important' }} />}
          label="Выбрано"
          sx={{
