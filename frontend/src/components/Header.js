...
const Header = () => {
  ...
  return (
    <ElevationScroll>
      <AppBar position="sticky" sx={{ background: 'linear-gradient(135deg, rgba(20, 20, 20, 0.98) 0%, rgba(31, 31, 31, 0.98) 100%)' }}>
        <Container maxWidth="xl">
          <Toolbar disableGutters>
            <MovieIcon sx={{ display: 'flex', mr: 1, fontSize: 32, color: '#e50914' }} />
            <Typography
              variant="h5"
              noWrap
              component="div"
