...
const Dashboard = () => {
    ...
    const loadDashboardStats = async () => {
        try {
            ...
            // Format statistics based on API response
    ...
    const allMenuItems = [
        ...
        {
            title: "Управление платежами по договорам",
            icon: <MoneyIcon />,
    ...
    // Фильтрация меню в зависимости от роли
    let menuItems = allMenuItems; // По умолчанию - все
        ...
        >
            ...
            {isStaff && (
                <Typography
                    ...
                    sx={{ mb: 3 }}
                >
                    Вы видите ограниченную версию панели управления как
                                ...
                                <ListItemIcon>
                                    <Box
                                        sx={{
                                            ...
                                            borderRadius: 2,
                                            background:
                                                "linear-gradient(135deg, rgba(229, 9, 20, 0.2) 0%, rgba(176, 7, 16, 0.2) 100%)",
                                            color: "#e50914",
                                            display: "flex",
                                            alignItems: "center",
                    ...
                    >
                        ...
                        >
                            <Typography
                                ...
                                color="text.secondary"
                            >
                                У вас нет доступа к разделам панели
                                администрирования
                            </Typography>
                            <Typography
                                variant="body2"
                                ...
                                sx={{ mt: 1 }}
                            >
                                Обратитесь к администратору системы для
