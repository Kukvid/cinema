...
const SessionsManage = () => {
  ...
  const handleOpenDialog = (session = null) => {
    ...
    if (session) {
      ...
      reset({ film_id: '', hall_id: '', cinema_id: '', start_time: '', base_price: 300 });
    }
    setDialogOpen(true);
  };
        ...
        <Table>
          <TableHead>
            <TableRow sx={{ background: 'rgba(229, 9, 20, 0.1)' }}>
              <TableCell sx={{ fontWeight: 600 }}>Фильм</TableCell>
              <TableCell sx={{ fontWeight: 600 }}>Кинотеатр</TableCell>
          ...
          <TableBody>
            {sessions.map((session) => (
              <TableRow key={session.id} hover>
                ...
                <TableCell>{session.hall?.cinema?.name}</TableCell>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <DialogContent>
            <TextField
              ...
              label="Фильм"
              margin="normal"
              {...register('film_id', { required: 'Фильм обязателен' })}
            ...
            <TextField
              ...
              label="Кинотеатр"
              margin="normal"
              {...register('cinema_id', { required: 'Кинотеатр обязателен' })}
            ...
            <TextField
              ...
              label="Зал"
              margin="normal"
              {...register('hall_id', { required: 'Зал обязателен' })}
            ...
            <TextField
              ...
              {...register('start_time', { required: 'Время обязательно' })}
            ...
            <TextField
              ...
              {...register('base_price', { required: 'Цена обязательна' })}
